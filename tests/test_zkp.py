...
from ac_package.util import pedersen_setup
from ac_package.zkp import ZKP_Schnorr, ZKP_Schnorr_FS, Damgard_Transfor
...
def test_interact_prove():
    ...
    assert(Schnorr.verify(pp, challenge, W_element, stm, response))
